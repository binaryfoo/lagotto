...
"""
  ...
  "--table *" should "build field list from first output row" in {
    ...
    output shouldBe
      """datetime,age,type,pause,heapBefore,heapAfter,heapReclaimed,heapMax,PSYoungGenBefore,PSYoungGenAfter,PSYoungGenReclaimed,PSYoungGenMax,ParOldGenBefore,ParOldGenAfter,ParOldGenReclaimed,ParOldGenMax,PSPermGenBefore,PSPermGenAfter,PSPermGenReclaimed,PSPermGenMax,heapAllocated,heapAllocationRate
        |2015-01-08 10:18:13.300,237468.441,Full GC,2.421151,2871497728,1489845248,1381652480,4270260224,18934784,0,18934784,1406926848,2852561920,1489845248,1362716672,2863333376,63901696,63813632,88064,139329536,2871497728,12
        |2015-01-08 15:16:55.969,255391.11,Full GC,2.36814,2865509376,1199139840,1666369536,4266786816,18200576,0,18200576,1403453440,2847308800,1199139840,1648168960,2863333376,63875072,63849472,25600,132513792,1375664128,76
        |2015-06-12 19:28:18.722,809846.37,GC--,0.425189,4224466944,4253652992,-29186048,4253679616,1390322688,1390322688,0,1390346240,,,,,,,,,3025327104,5
        |""".stripMargin
  }
