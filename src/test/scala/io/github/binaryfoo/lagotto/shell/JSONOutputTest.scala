...
class JSONOutputTest extends LagoTest {
  ...
  "JSON output" should "write some json" in {
    ...
    output shouldBe """{"at":"1969-12-31T21:00:00.000-0300","mti":"0200","stan":12345,"lifespan":1001,"48.1":"private"}"""
  }

  it should "unpack a gzipped string" in {
    val entry = LogEntry("at" -> new DateTime(0L, UYST_TZ).asJposAt, "realm" -> "acme-terminal", "259" -> GZip.zip("line one\nline two"))
