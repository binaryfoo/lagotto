...
class Log4jLogTest extends LagoTest {
  ...
  "log4j record" should "not consume a following jpos record" in {
    val iterator = new LineIterator(inputStreamFrom( """[08 Nov 2014 00:00:00,001] INFO  [a.ClassName]: Did something useful
  ...
  it should "include two lines in multiline record" in {
    val iterator = new LineIterator(inputStreamFrom( """[08 Nov 2014 00:00:00,001] INFO  [a.ClassName]: Line 1
                                                       |Line 2
