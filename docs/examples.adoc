...
Only output entries with an MTI (field 0) of 2100 using --field.
    ...
    [33m<log[0m realm=[32m"channel/127.0.0.1:9001"[0m at=[32m"Thu Dec 18 15:12:40 UYST 2014.330"[0m lifespan=[32m"1ms"[0m[33m>[0m
      [33m<send[0m[33m>[0m
        [33m<isomsg[0m direction=[32m"outgoing"[0m[33m>[0m
          <!-- org.jpos.iso.packager.GenericPackager[cfg/jcard.xml] -->
          [33m<field[0m id=[32m"0"[0m value=[32m"2100"[0m[33m/>[0m
          [33m<field[0m id=[32m"2"[0m value=[32m"6009330000000021"[0m[33m/>[0m
          [33m<field[0m id=[32m"3"[0m value=[32m"300000"[0m[33m/>[0m
          [33m<field[0m id=[32m"4"[0m value=[32m"8582000000000000"[0m[33m/>[0m
          [33m<field[0m id=[32m"7"[0m value=[32m"1218151240"[0m[33m/>[0m
          [33m<field[0m id=[32m"11"[0m value=[32m"000000000002"[0m[33m/>[0m
          [33m<field[0m id=[32m"12"[0m value=[32m"20141218151240"[0m[33m/>[0m
          [33m<field[0m id=[32m"14"[0m value=[32m"1001"[0m[33m/>[0m
          [33m<field[0m id=[32m"15"[0m value=[32m"20141218"[0m[33m/>[0m
          [33m<field[0m id=[32m"17"[0m value=[32m"1218"[0m[33m/>[0m
          [33m<field[0m id=[32m"22"[0m value=[32m"10000000080000000004000001000000"[0m type=[32m"binary"[0m[33m/>[0m
          [33m<field[0m id=[32m"32"[0m value=[32m"000001"[0m[33m/>[0m
          [33m<field[0m id=[32m"37"[0m value=[32m"180312760317"[0m[33m/>[0m
          [33m<field[0m id=[32m"41"[0m value=[32m"29110001"[0m[33m/>[0m
          [33m<field[0m id=[32m"42"[0m value=[32m"001001"[0m[33m/>[0m
          [33m<isomsg[0m id=[32m"43"[0m[33m>[0m
            [33m<field[0m id=[32m"2"[0m value=[32m"jCard Selftest system"[0m[33m/>[0m
            [33m<field[0m id=[32m"4"[0m value=[32m"Montevideo"[0m[33m/>[0m
            [33m<field[0m id=[32m"5"[0m value=[32m"MV"[0m[33m/>[0m
            [33m<field[0m id=[32m"7"[0m value=[32m"UY"[0m[33m/>[0m
          [33m</isomsg>[0m
          [33m<isomsg[0m id=[32m"113"[0m[33m>[0m
            [33m<field[0m id=[32m"2"[0m value=[32m"106"[0m[33m/>[0m
          [33m</isomsg>[0m
        [33m</isomsg>[0m
      [33m</send>[0m
    [33m</log>[0m
...
Output a slightly less wordy output. Supports translation of field paths to names using a dictionary (TODO explain...).
    ...
    [33m<log[0m realm=[32m"channel/127.0.0.1:9001"[0m at=[32m"2014-12-18 15:12:40.330"[0m type=[32m"send"[0m lifespan=[32m"1"[0m[33m>[0m
      0: [32m2100[0m [mti]
      2: [32m6009330000000021[0m [Primary account number]
      3: [32m300000[0m [Processing code]
      4: [32m8582000000000000[0m [Transaction amount]
      7: [32m1218151240[0m [Transmission date and time]
      11: [32m000000000002[0m [System trace audit number]
      12: [32m20141218151240[0m [Local transaction time]
      14: [32m1001[0m [Expiration date]
      15: [32m20141218[0m [Settlement date]
      17: [32m1218[0m [Capture date]
      22: [32m10000000080000000004000001000000[0m [Point of service entry mode]
      32: [32m000001[0m [Acquiring institution identification code]
      37: [32m180312760317[0m [Retrieval reference number]
      41: [32m29110001[0m [Card acceptor terminal identification]
      42: [32m001001[0m [Card acceptor identification code]
      43.2: [32mjCard Selftest system[0m [City]
      43.4: [32mMontevideo[0m [Country]
      43.5: [32mMV[0m
      43.7: [32mUY[0m
      113.2: [32m106[0m
    [33m</log>[0m
